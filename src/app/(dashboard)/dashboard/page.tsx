      ...
      <div className="flex w-full flex-col">
        <main className="flex flex-1 flex-col gap-4 md:gap-8">
          <Card className="w-full bg-gradient-to-br from-secondary to-green-800 text-secondary-foreground shadow-lg transition-all hover:shadow-xl">
            <CardHeader>
              <CardTitle className="text-3xl">Get Started with Your Tax Calculation</CardTitle>
              <CardDescription className="text-secondary-foreground/80">
                Ready to see how TaxAI can simplify your finances? Click the button below to begin.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground shadow-lg animate-fade-in-up">
